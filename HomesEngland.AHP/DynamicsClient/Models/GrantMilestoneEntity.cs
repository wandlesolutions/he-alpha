...
{
	public const string QueryFields = "hea_schememilestoneid,_hea_programmescheme_value,hea_completed,hea_completeddate,hea_grantpercentageawarded,hea_targetdate,hea_milestonetype";
	...
	[JsonProperty("hea_grantpercentageawarded")]
